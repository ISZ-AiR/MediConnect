...
<i className="bi bi-calendar-event text-primary" style={{ fontSize: "3rem" }}></i> <h2 className="fw-bold mt-3 mb-2">Schedule Details</h2> <p className="text-muted">Information about the schedule</p> </div>
            ...
            {!loading && !error && item && (
              <div className="mb-4">
                <p><strong>Schedule ID:</strong> {item.schedule_id}</p>
                <p><strong>Doctor ID:</strong> {item.doctor_id}</p>
                <p><strong>Date:</strong> {item.schedule_date}</p>
