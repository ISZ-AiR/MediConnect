...
<i className="bi bi-calendar-plus text-warning" style={{ fontSize: "3rem" }}></i> <h2 className="fw-bold mt-2 mb-2">My Visits</h2> <p className="text-muted">All your scheduled visits</p> </div>
