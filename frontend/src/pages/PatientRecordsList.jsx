...
const PatientVisitsList = () => {
  ...
  const filteredVisits = paginatedVisits.filter((v) => {
    ...
    const doctorMatch =
      !filters.doctor ||
      getDoctorName(v.reservation_id) === getUserName(parseInt(filters.doctor));
    const nurseMatch =
      !filters.nurse ||
      getNurseName(v.nurse_id) === getUserName(parseInt(filters.nurse));
            ...
            <div className="d-flex flex-wrap gap-3">
              ...
              >
                ...
                <select
                  ...
                  value={filters.nurse || ""}
                  onChange={(e) =>
                    setFilters({ ...filters, nurse: e.target.value })
                  }
                >
                  <option value="">All</option>
                  {nurses.map((n) => {
