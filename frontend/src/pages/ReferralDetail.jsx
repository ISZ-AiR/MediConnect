      ...
      <div className="container py-5 d-flex justify-content-center">
        ...
        >
          ...
          <div className="mb-3 pb-3 border-bottom">
            <p>
              <span className="fw-bold">Referral ID:</span> {item.referral_id}
            </p>
            <p>
            ...
            <p>
              <span className="fw-bold">PESEL:</span>{" "}
              {item.patient_pesel || "-"}
            </p>
            <p>
            ...
            <p>
              <span className="fw-bold">Referral Date:</span>{" "}
              {item.referral_date}
            </p>
          </div>
          ...
          <div className="mb-4">
            <p>
              <span className="fw-bold">Examination:</span>{" "}
              {item.examination_name || item.examination_id}
            </p>
            <p>
              <span className="fw-bold">Notes:</span> {item.notes || "-"}
            </p>
          </div>
