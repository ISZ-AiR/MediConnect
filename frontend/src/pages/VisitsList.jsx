...
return doctorUser ? `${doctorUser.first_name} ${doctorUser.last_name}` : `Doctor ${doctor.doctor_id}`;
};
...
return ( <div className="min-vh-100 bg-light"> <Navbar /> <div className="container py-5"> <div className="card shadow-sm border-0 p-4 mb-4"> <div className="text-center mb-3">
<i className="bi bi-calendar-plus text-warning" style={{ fontSize: "3rem" }}></i> <h2 className="fw-bold mt-2 mb-2">Visits</h2> <p className="text-muted">Manage patient visits</p> </div>
                  ...
                  <td>
                    <div className="btn-group" role="group">
                      <button
                        ...
                        onClick={() => navigate(`/receptionist/visits/${v.visit_id}`)}
                      >
                        View
                      </button>
                      <button
                        className="btn btn-sm btn-outline-secondary"
                        onClick={() => navigate(`/receptionist/visits/edit/${v.visit_id}`)}
                      >
                        Edit
                      </button>
                      <button
