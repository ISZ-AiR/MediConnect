...
setItems(prev => prev.filter(it => it.reservation_id !== reservation_id));
} catch (err) {
console.error(err);
...
<i className="bi bi-calendar-check text-primary" style={{ fontSize: "3rem" }}></i> <h2 className="fw-bold mt-2 mb-2">Reservations</h2> <p className="text-muted">Manage patient reservations</p> </div>
