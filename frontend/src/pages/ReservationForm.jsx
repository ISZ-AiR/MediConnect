...
const ReservationForm = () => {
  ...
  useEffect(() => {
    const loadDropdowns = async () => {
      try {
        const [patientsRes, doctorsRes, nursesRes, usersRes] =
          await Promise.all([
            apiRequest("/patients"),
            apiRequest("/doctor"),
            apiRequest("/nurse"),
  ...
  useEffect(() => {
    ...
    const sched = schedules.find(
      (s) =>
        Number(s.doctor_id) === Number(form.doctor_id) &&
      ...
      <div className="container py-5">
        ...
        <div className="card shadow-sm p-4">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-muted">Manage patient reservation</p>{" "}
          </div>
            ...
            <div className="mb-3 d-flex align-items-center">
              ...
              <div className="w-100 d-flex flex-column">
                ...
                <Typeahead
                  ...
                  onChange={(selected) => {
                    if (selected.length)
                      setForm({ ...form, patient_id: selected[0].patient_id });
                  }}
            ...
            <div className="mb-3 d-flex align-items-center">
              ...
              <div className="w-100 d-flex flex-column">
                ...
                <Typeahead
                  id="doctor-typeahead"
                  labelKey={(d) =>
                    `${d.doctor_id} - ${d.user?.first_name || ""} ${
                      d.user?.last_name || ""
                    }`
                  }
                  options={doctors}
                  selected={doctors.filter(
                    (d) => d.doctor_id === form.doctor_id
                  )}
                  onChange={(selected) => {
                    if (selected.length)
                      setForm({ ...form, doctor_id: selected[0].doctor_id });
                  }}
            ...
            <div className="mb-3 d-flex align-items-center">
              ...
              <div className="w-100 d-flex flex-column">
                ...
                <Typeahead
                  ...
                  onChange={(selected) => {
                    if (selected.length)
                      setForm({ ...form, nurse_id: selected[0].nurse_id });
                  ...
                  {availableSlots.map((slot) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        setForm({
                          ...form,
                          reservation_time: slot.toISOString(),
                        });
                      }}
                    >
